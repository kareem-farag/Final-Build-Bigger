...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myApi/v1/getJokes/";
  ...
  public class GetJokes extends MyApiRequest<com.udacity.gradle.builditbigger.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJokes#execute()} method to invoke the remote operation. <p> {@link
     * GetJokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
    ...
    @Override
    public GetJokes setAlt(String alt) {
      return (GetJokes) super.setAlt(alt);
    }

    @Override
    public GetJokes setFields(String fields) {
      return (GetJokes) super.setFields(fields);
    }

    @Override
    public GetJokes setKey(String key) {
      return (GetJokes) super.setKey(key);
    }

    @Override
    public GetJokes setOauthToken(String oauthToken) {
      return (GetJokes) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJokes setPrettyPrint(Boolean prettyPrint) {
      return (GetJokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJokes setQuotaUser(String quotaUser) {
      return (GetJokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJokes setUserIp(String userIp) {
    ...
    public GetJokes setName(String name) {
      this.name = name;
      return this;
    }
